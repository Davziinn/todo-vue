  ...
  <div class="container">
    ...
    <ul class="list-group mt-4">
      <li class="list-group-item" v-for="tarefa in getTarefasFiltradas()" :key="tarefa.titulo">
        <input @change="evento => tarefa.finalizada = evento.target.checked" type="checkbox" v-model="tarefa.finalizada" :id="tarefa.titulo" :checked="tarefa.finalizada">
        <label :class="{ done: tarefa.finalizada }" class="ms-3c" :for="tarefa.titulo">
          {{ tarefa.titulo }}
        </label>
      </li>
    </ul>
